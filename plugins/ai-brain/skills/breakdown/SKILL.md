...
<process>
1. Read the Plan Protocol, Activity Labels, and Task Format sections from `/Users/yannrapaport/ai-brain/assistants/todos.md`
2. Read `/Users/yannrapaport/ai-brain/todos/active-todos.md` to understand current tasks and structure
